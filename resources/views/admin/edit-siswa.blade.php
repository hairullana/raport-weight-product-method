                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama" class="form-control @if($errors->has('nama')) is-invalid @endif" placeholder="Nama" name="nama" value="{{ $siswa->nama }}" required></div>
                                                    @if ($errors->has('nama'))
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_active" id="is_active" class="form-select" required>
                                                        ...
                                                        <option value="0" @if ($siswa->is_active == 0) @selected(true) @endif>Tidak Aktif</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
