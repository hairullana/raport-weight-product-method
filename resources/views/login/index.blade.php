...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/login-assets/images/bg-02.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="{{ route('auth.login-action') }}">
					...
					{{-- <div class="text-center p-t-90">
						<a class="txt1" href="/login-assets/#">
							Forgot Password?
						</a>
					</div> --}}
				</form>
